Of course. It's crucial to document this powerful new feature. Adding the dual-mode capability makes the application significantly more versatile, and the `README.md` should reflect that.
